#!/bin/bash
dotnet publish ./ApigwLambdaDynamoDbSqs.csproj --configuration "Release" --framework "netcoreapp3.1" /p:PublishReadyToRun=true /p:GenerateRuntimeConfigurationFiles=true --runtime linux-musl-x64 --self-contained false || exit 1
